# Дашборд для мониторинга ключевых показателей авиакомпании

## Контекст
Авиакомпания нуждается в инструменте для мониторинга выручки, структуры флота и ценовой политики.

## Задача
Разработать дашборд, позволяющий анализировать:
- динамику выручки
- вклад различных классов обслуживания
- эффективность различных моделей самолётов

## Пользователь
Финансовый аналитик / продуктовый аналитик

## Решение
Создан интерактивный дашборд в Apache Superset, объединяющий ключевые метрики бизнеса.

## Структура дашборда
- Выручка по дням (с разбивкой по классам)
- Распределение мест по моделям самолётов
- Средняя стоимость билета по моделям

## Ключевые инсайты
- Бизнес-класс генерирует наибольшую выручку на пассажира
- Разные модели самолётов демонстрируют различия в среднем чеке
...
```
## Выводы
Выявлены наиболее прибыльные типы воздушных судов и классы обслуживания.
Проанализирована динамика поступления денежных средств, что позволяет точнее планировать маркетинговые активности.
Сформирован удобный инструмент для оперативного мониторинга ключевых KPI авиакомпании.
